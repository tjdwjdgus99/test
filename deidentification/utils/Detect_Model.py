...
from deidentification.utils.utils import xywh2xyxy, nms, draw_detections
...
class Detect_Model:
    ...
    def detect_objects(self, image):
        ...
        #print(f"Inference time for this frame: {inference_time:.2f} ms")
        #print(f"Inference time for this frame: {inference_time / 1000:.2f} seconds")
